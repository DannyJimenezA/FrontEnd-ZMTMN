...
const MiPerfil = () => {
  ...
  //       let cedulaSinPrefijo = usuario.cedula;
  //       if (usuario.cedula?.startsWith('CR-')) cedulaSinPrefijo = usuario.cedula.replace('CR-', '');
  //       else if (usuario.cedula?.startsWith('RES-')) cedulaSinPrefijo = usuario.cedula.replace('RES-', '');
  //       else if (usuario.cedula?.startsWith('PAS-')) cedulaSinPrefijo = usuario.cedula.replace('PAS-', '');

  //       setFormData({ ...usuario, cedula: cedulaSinPrefijo });
  //     } catch (error) {
  //       console.error('Error al cargar el perfil:', error);
  //     }
  //   };
